...
<?php $row = $this->db->get_where('videos',array('video_id'=>$video_id))->row_array(); ?>
          <!-- Content Row -->
          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <form class="user" method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/edit_video/update/<?php echo $video_id; ?>">
                <div class="card-body">
