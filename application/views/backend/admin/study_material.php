          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <form class="user" method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/study_material/create">
                <div class="card-body">
            ...
            <div class="col-lg-6 mb-4">
              <div class="row">
                <?php $notes = $this->db->get('study_material')->result_array(); ?>
                      ...
                      <div class="card-body">
                        ...
                        <div>
                         ...
                         <div style="margin-top: 15px;margin-left: 20px;">
                           ...
                           <a href="<?php echo base_url().'admin/study_material/delete/'.$row['material_id']; ?>" style="margin-left: 20px; color : red;"><i class="fas fa-trash" style="color: #eb0000"></i></a>
                         </div> 
                      </div>
                    </div>
                  </div>
