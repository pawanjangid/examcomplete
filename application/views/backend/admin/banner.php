          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <form class="user" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/banner/create">
                <div class="card-body">
                  ...
                  <div class="mb-4">
                    <select class="form-control" name="type" required="required">
                      <option value="">-Select Banner Type-</option>
                          <option value="Home">Home Screen Banner</option>
            ...
            <div class="col-lg-6 mb-4">
              <div class="row">
                <?php $banner = $this->db->get('banner')->result_array(); ?>
