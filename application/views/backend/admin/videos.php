          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <form class="user" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/video/<?php echo $topic_id; ?>/create">
                <div class="card-body">
            ...
            <div class="col-lg-6 mb-4">
              <div class="row">
                <?php $videos = $this->db->get_where('videos',array('topic_id'=>$topic_id))->result_array(); ?>
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                         ...
                         <div style="margin-top: 15px;margin-left: 20px;">
                           <a href="<?php echo base_url().'admin/edit_video/none/'.$row['video_id']; ?>" ><i class="fas fa-edit" style="color: white"></i></a>
                           <a href="<?php echo base_url().'admin/edit_video/delete/'.$row['video_id']; ?>" style="margin-left: 20px; color : red;"><i class="fas fa-trash" style="color: #eb0000"></i></a>
                         </div> 
                      </div>
                    </div>
                  </div>
